...
router.post(`/create-indexes`, async (req, res) => {
  try {
    ...
    await collection.createIndex({ class_id: 1 }); //Create single-field index on class_id

    await collection.createIndex({ learner_id: 1 }); //Create single-field index on learner_id

    await collection.createIndex({ learner_id: 1, class_id: 1 }); //Create single-field index on learner_id and class_id
